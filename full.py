...
#replece mode value with missing value
...
#countplot for p class column
sns.countplot(x='Pclass', data=titanic_data)

sns.countplot(x='Sex', hue='Survived', data=titanic_data)

#Encode Categorical Columns or Data
titanic_data['Sex'].value_counts()
...
#Logistical Regression and Testing
model=LogisticRegression()
#use the train data on logistical regressoion and model
...
ngrok.set_auth_token("30Ez389O5YRYCJp1Z2qSvRC726q_nVyv4b9hS4f5BCfKwQsd")
...
<head>
    ...
    <title>Titanic Survival Prediction Model by Sm1oxs</title>
    <style>
        body {
